          ...
          <div className="flex w-full h-full mx-auto text-left">
            <div className="relative inline-flex items-center mx-auto align-middle">
              ...
              <h1 className="max-w-5xl inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text text-transparent text-6xl md:text-7xl lg:text-9xl lg:max-w-7xl">
                ...
                La página que estas buscando pudo ser removida, sufrió un cambio de nombre o temporalmente no está disponible.
                </p>
                <div className="flex justify-center w-full max-w-2xl gap-2 mx-auto mt-6">
                  <div className="mt-3 rounded-lg sm:mt-0">
                    <Link to={"/"}> 
                    <button className="items-center font-bold block px-5 py-4 text-base text-center text-white transition duration-500 ease-in-out transform bg-blue-600 lg:px-10 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 animate-pulse" style={{ backgroundColor: '#0D0D0D', animationDuration: '3s' }}>
                      Volver al inicio
                    </button>
                    </Link>
                  </div>
